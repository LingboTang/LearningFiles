...
public class DMDRegressionModel {
    ...
    public static void main(String[] args) throws Exception {
         ...
         * You can customize your input file here
         * I can add input file as one command line options
         */
        BufferedReader datafile = readDataFile("/home/lingbo/Desktop/LearningFiles/Data/selectedAttributes.arff");
         ...
         * For more options, read the weka documents: https://weka.wikispaces.com/Use+WEKA+in+your+Java+code
         */
        ...
        /*
         * Performance the cross validation
         */
